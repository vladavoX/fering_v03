...
const callouts = [
  {
    name: 'Klub Stolovi',
    description: 'Klubski stolovi za Vaše goste',
  ...
  },
  {
    ...
    description: 'Trpezarisjki stolovi za Vaš dom',
  ...
  },
  {
    ...
    description: 'Ugradite vrhunski sto u Vaš poslovni prostor',
  ...
  {
    name: 'Komode',
    description: 'Komode, spremne za Vaše stvari.',
  ...
  {
    name: 'Stepeništa',
    description: 'Vrhunski dizajnirano stepenište, jos boljeg kvaliteta.',
  ...
  {
    name: 'Ostalo',
    description: 'Raznovrsni proizvodi od metala.',
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
          <h2 className="text-3xl font-extrabold text-gray-900">Proizvodi</h2>
